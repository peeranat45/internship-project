...
def getIDSInterface():
    ...
    # print(edgeRouter)
    print(int(IDS_ADDR.split(":")[1]))
    print(findDictWithKey(edgeRouter, 'routerID', int(IDS_ADDR[-4])))
    return findDictWithKey(edgeRouter, 'routerID', int(IDS_ADDR.split(":")[1]))['interface'][0]
